...
public abstract class Forme {
    ...
    public void produire() {
        Optional<Integer> textureBase = Tisseur.obtenir(parent.identifiant(), Tisseur.PSEUDO_BASE);
        Optional<Integer> textureSurvole = Tisseur.obtenir(parent.identifiant(), Tisseur.PSEUDO_SURVOLE);
        Optional<Integer> textureActiver = Tisseur.obtenir(parent.identifiant(), Tisseur.PSEUDO_ACTIVER);
