...
public abstract class Forme {
    ...
    public Forme(Element parent, float[] positions, float[] textures, int[] indices, boolean fixe, Colorisation colorisation) {
        this.parent = parent;
        this.fixe = fixe;
    ...
    public abstract void survoler(Fenetre.Souris souris, Matrice<Float> transformation);

    public void activer(Fenetre.Souris souris) {
        if (survole) {
            active = !active;
            souris.deselectionner();
        } else {
            active = false;
        }
    }
    ...
    public void produire() {
        Optional<Integer> textureBase = Tisseur.obtenir(parent.getIdentifiant(), Tisseur.PSEUDO_BASE);
        Optional<Integer> textureSurvole = Tisseur.obtenir(parent.getIdentifiant(), Tisseur.PSEUDO_SURVOLE);
        Optional<Integer> textureActiver = Tisseur.obtenir(parent.getIdentifiant(), Tisseur.PSEUDO_ACTIVER);
