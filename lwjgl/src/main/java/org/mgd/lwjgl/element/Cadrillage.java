...
public class Cadrillage extends ElementActivable<Integer[], Void> {
    private final int replicationAbscisse;
    private final int replicationOrdonnee;
    private final Map<Forme, Integer[]> indexation;

    public Cadrillage(Fenetre parent, String identifiant, int replicationAbscisse, int replicationOrdonnee, float z, Map<String, String> textures) throws LwjglException {
    ...
    @Override
    public Integer[] elementActivation(Forme forme) {
        return indexation.get(forme);
    }
