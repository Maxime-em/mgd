...
public abstract class ElementAnimateur<A> extends Element implements Animateur, Activable<A>, Desactivable {
    ...
    protected ElementAnimateur(Fenetre parent, String identifiant, float[] translation, float[] agrandissement, float[] rotation, Map<String, Path> textures) throws LwjglException {
