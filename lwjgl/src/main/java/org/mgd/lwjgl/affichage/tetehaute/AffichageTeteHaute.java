...
public abstract class AffichageTeteHaute extends Primitif implements Producteur {
    ...
    public void dessiner(Ecrit ecrit, float x, float y) {
        ...
        nvgText(contexte, x, y, ecrit.texte.get());
    }
    ...
    public static class Ecrit {
        ...
        public Ecrit(float taille, NVGPolice police, NVGCouleur couleur, Supplier<String> texte, float[] marges) {
    ...
    public static class Bouton<T> extends Ecrit implements Activable<T> {
        ...
        public Bouton(String identifiant, float taille, NVGPolice police, NVGCouleur couleur, Supplier<String> texte, float[] marges, T objet) {
    ...
    public static final class Action implements Activable<Integer> {
        public final Integer index;
        public final NVGImage image;
        private final LinkedList<Activation<Integer>> activations;
        ...
        public Action(Integer index, int largeur, int hauteur, boolean anime, boolean ephemere, NVGImage image) {
            this.activations = new LinkedList<>();
            this.index = index;
            this.image = image;
        ...
        @Override
        public Collection<Activation<Integer>> activations() {
            return activations;
        }
